...
#### GDP per capita in 2003 as the independent variable
```{r}
...
#### Marketsize as the independent variable
```{r}
...
#### Relationship with clients and suppliers as the independent variable
```{r}
...
#### Licenses as the independent variable
```{r}
...
#### Log of the CEO pay as the independent variable
```{r}
