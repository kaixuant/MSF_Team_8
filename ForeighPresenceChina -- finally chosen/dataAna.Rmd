...
#### 3.3.1.5 what kind of province-level variables influence province's GDP per capita?
```{r}
...
### 4.3.1 Single Variable Linear Regression Test with Revenue as the dependent variable
...
#### 4.3.1.1 GDP per capita in 2003 as the independent variable
```{r, echo=FALSE}
...
#### 4.3.1.2 Marketsize as the independent variable
```{r}
...
#### 4.3.1.3 Relationship with clients and suppliers as the independent variable
```{r}
...
#### 4.3.1.4 Licenses as the independent variable
```{r}
...
#### 4.3.1.5 Log of the CEO pay as the independent variable
```{r}
...
### 4.3.2 Multiple Linear Regression Test with revenue as the dependent variable
