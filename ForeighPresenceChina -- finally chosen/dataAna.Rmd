...
#load("C:/Users/Kaixuan/Documents/MSF_Team_8/ForeighPresenceChina -- finally chosen/ForeignPresence&ETCs.RData")
mnc <- as.data.frame(x)
ls.str(mnc)
summary(mnc)
...
stargazer(list(rev_ceo, rev_reg1), digits = 2, no.space = TRUE, type = 'html', title = 'Regression Analysis')
...
Other things we discovered in this analysis were:

The MNC activity and GDP per capita had a high positive correlation, which indicates that FDI (foreign direct investment) could stimulate the economy of China.
