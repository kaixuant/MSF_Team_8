...
pairs(lgdpper2003 ~ lwdist + lpop2003 + MNC, data = mnc.prov)
...
pairs(gdp2003 ~ lgdpper2003 + lwdist + lpop2003 + MNC, data = mnc.prov, lower.panel = panel.smooth, upper.panel = panel.cor)
...
```{r, echo = FALSE}
>>>>>>> 0c390a1189b7393a14efaaa730ff0048c6c0007e
mnc[,"ownership"] <- NA
for (j in 1:nrow(mnc)){
